...
🚫 Free: 3 respostas, 1 print, 3 conversas por dia. Pra teste, ok. Pra resolver, vai te frustrar.

✅ Parceiro — R$ 29,90/mês: tudo do trial, ilimitado. Cancela em 1 mensagem.

🚀 Parceiro Pro — R$ 79,90/mês: tudo do Parceiro + auditoria do teu perfil + análise da pretendente + preparação pré-encontro + análise pós.
