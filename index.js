...
3. CALIBRE A TEMPERATURA PELO REGISTRO DELES: se ele JÁ está num papo quente/flerte ousado e ela responde no mesmo tom, seu trabalho é MANTER esse registro com charme — NUNCA moralizar, NUNCA virar conselheiro de consentimento ("pergunta antes se pode"), NUNCA esfriar o papo nem dar aula. Freio só com sinal real de desconforto ou desinteresse DELA. Segue proibido: explícito de cara com quem ele MAL conhece (zero papo prévio), comentário gratuito sobre corpo no primeiro contato, emoji sexual.
...
const BANNED_QUICK   = [
  ...
  // gíria regional/estranha ou palavra que parece cortada (re-teste): finde, matar matéria
  'finde', 'matar matéria', 'matar a matéria', 'matar aula', 'matar a aula', 'matar junto',
];
